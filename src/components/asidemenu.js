          ...
          <div className="flex flex-wrap justify-center -mx-4">
            <div className="w-full px-4 mb-4 md:w-2/12 md:mb-0 accordion">
              ...
              <ul className="invisible h-0 overflow-hidden md:h-auto md:visible">
                <li>
                  <a href="/" className="block py-1 hover:underline">Shipping</a>
                </li>
                <li>
                  <a href="/" className="block py-1 hover:underline">Refund</a>
                </li>
                <li>
                  <a href="/" className="block py-1 hover:underline">Promotion</a>
                </li>
              </ul>
            </div>
            <div className="w-full px-4 mb-4 md:w-2/12 md:mb-0 accordion">
              ...
              <ul className="invisible h-0 overflow-hidden md:h-auto md:visible">
                <li>
                  <a href="/" className="block py-1 hover:underline">About</a>
                </li>
                <li>
                  <a href="/" className="block py-1 hover:underline">Career</a>
                </li>
                <li>
                  <a href="/" className="block py-1 hover:underline">Contact Us</a>
                </li>
              </ul>
            </div>
            <div className="w-full px-4 mb-4 md:w-2/12 md:mb-0 accordion">
